    ...
    <div style="max-width: 1440px; margin: 0 auto; padding: 0 28px; height: 62px; display: flex; align-items: center; gap: 28px">
      ...
      <div style="display: flex; align-items: center; gap: 10px; flex: none">
        ...
        <button
          disabled
          title="Ships in Phase 2"
          style="border: 0; cursor: not-allowed; opacity: 0.5; background: var(--color-orange); color: var(--color-navy); padding: 9px 14px; font: 400 12px 'Archivo Black', sans-serif; letter-spacing: 0.06em; white-space: nowrap; flex: none"
        >
          + ADD ITEM
        </button>
